{ config, lib, pkgs, pkgs-opt, sergv, ... }:
{
  config.home-manager.users."${config.sergv.user.name}" =
    ...
    in
    {
      ...
      programs.chromium = {
        ...
        # sergv.pkgs-pristine.chromium
        # pkgs.google-chrome
        package = sergv.pkgs-pristine.ungoogled-chromium;
      };
      ...
      home.packages =
        [
          ...
          sergv.pkgs-pristine.anki
          pkgs.bridge-utils
          pkgs.fahclient
          # for shsplit
          pkgs.shntool
          sergv.pkgs-pristine.telegram-desktop
          ...
          sergv.pkgs-pristine.thunderbird
          sergv.pkgs-pristine.libreoffice

# Based on /home/sergey/projects/nix/nixpkgs/pkgs/applications/science/misc/foldingathome/client.nix
{ lib
, buildFHSEnv
, fetchFromGitHub
, ocl-icd
...
let
  ...
  cbangSrc = fetchFromGitHub {
    ...
    sha256 = "sha256-acAImItdkgo6PBFL6Vu/caIdcnvp/3VEW2lgVDgKy9g="; #lib.fakeSha256;
  };
  ...
  fah-client = stdenv.mkDerivation {
    ...
    src = fetchFromGitHub {
      ...
      rev    = "v${version}";
      sha256 = "sha256-d+LY/R4TAko+2e2W76KEBQ8fXj0hzzmBOm+c4tksXMA="; #lib.fakeSha256;
    };

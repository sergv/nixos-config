...
++ [
  ...
  (mkPatch "add-more-march-variants"
  ...
  (mkPatch "custom-kernel-timer-frequency"
...

  {
    ...
    structuredExtraConfig = {
      ...
      LTO_CLANG = yes;
      LTO_CLANG_THIN = yes;
      # full LTO is much more expensive
      # LTO_CLANG_FULL = yes;
  ...
  {
    name = "Fallout from everything else";
    patch = null;
    structuredExtraConfig = {
      CROS_EC_ISHTP = unset;
      TPS68470_PMIC_OPREGION = unset;

  ...
  ghcBinDists = {
    ...
    defaultLibc = {
      x86_64-linux = {
        variantSuffix = "";
        src = {
          url = "${downloadsUrl}/${version}/ghc-${subversion}-x86_64-deb10-linux.tar.xz";
          sha256 = "c16f3dc4a9ffbac2a0666cc94da5da161d17e4a7adcd5d9798464cf601f36db9";
        };

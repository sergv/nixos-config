...
in
{
  ...
  tar7zUltra = writePatchedScriptBin "tar7zUltra" [
    pkgs.gnutar
    pkgs.p7zip
  ];
  targz = writePatchedScriptBin "targz" [
    pkgs.gnutar
    pkgs.gzip
  ];
  targz-fast = writePatchedScriptBin "targz-fast" [
    pkgs.gnutar
    pkgs.gzip
  ];
  tarbz2 = writePatchedScriptBin "tarbz2" [
    pkgs.gnutar
    pkgs.bzip2
  ];
  tarlz = writePatchedScriptBin "tarlz" [
    pkgs.gnutar
    pkgs.lzip
  ];
  tartar = writePatchedScriptBin "tartar" [ pkgs.gnutar ];
  tarxz = writePatchedScriptBin "tarxz" [
    pkgs.gnutar
    pkgs.xz
  ];
  ...
  wm-sh = writePatchedScriptBin "wm.sh" [
    pkgs.wmctrl
    pkgs.coreutils
  ];
}
